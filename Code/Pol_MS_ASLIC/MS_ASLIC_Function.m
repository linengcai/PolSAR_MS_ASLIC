...
function [Label, lenSP, BR, ASA] = MS_ASLIC_Function(dataPath, s, img, span, ENL, ESM, realEdge)
...
% 显示原图像和带标签的图像
img_pauli = fPauliImShow(img);
figure;
imshow(imoverlay(img_pauli, Boundary, 'red')); % 原图上叠加边界
